...
## 7. 데이터 모델 — 선설명·팁·스샷 슬롯 (#57에서 계약)

감사 당시(#50)에는 아래 키가 없었습니다. 계약·빈 칸 렌더는 [content-schema.md](content-schema.md)와 `tools/web/content_schema.py`입니다. 본문 시드는 후속 #53·#54·#58입니다.
