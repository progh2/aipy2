...
def unit_scripts(prefix,unit):
 extras=''
 if unit:
  extras+=f'<script type="module" src="{prefix}assets/teacher-focus.js?v=2"></script>'
 return extras
