...
def unit_scripts(prefix,unit):
 extras=''
 if unit:
  extras+=f'<script type="module" src="{prefix}assets/teacher-focus.js?v=6"></script>'
 return extras
...
(WEB/'teacher/admin.html').write_text(teacher_manage('roster','학생 명단 관리',admin_body,'<script type="module" src="../assets/admin.js?v=3"></script>'))
