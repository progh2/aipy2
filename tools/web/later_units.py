...
'스팸 분류의 FP와 정밀도, 가격 같은 수치 예측과 회귀, 정답 없는 고객 군집, AI 포함 관계, 과대 적합 방지, DataFrame.describe를 모두 설명할 수 있는지 확인하세요.'],['문제·데이터 카드','분할·전처리 코드','모델 비교·선택','최종 지표·한계','저널·코드 제출'],['산출물','포함할 것'],[['실행 코드','재현 조건과 패키지'],['결과 표','훈련·검증·테스트 역할'],['해석','오류 사례와 개선 근거']],['ml-metrics'],['같은 파이프라인에서 k 후보 하나를 추가하고 선택 근거를 기록하세요.'])
